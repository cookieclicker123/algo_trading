...
class NotificationMessage(BaseModel):
    ...
    classification: str = Field(default="", description="Classification category (e.g., 'imminent') - empty for trade notifications")
    confidence: str = Field(default="", description="Confidence level (e.g., 'HIGH') - empty for trade notifications")
    reasoning: str = Field(default="", description="Classification reasoning - empty for trade notifications")
